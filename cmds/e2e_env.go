...
func NewCmdE2eEnv(f cmdutil.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "e2e-env",
		Short:   "Generates the E2E secrets environment variables for use by the E2E test pipeline",
		Long:    `Generates the E2E secrets environment variables for use by the E2E test pipeline`,
